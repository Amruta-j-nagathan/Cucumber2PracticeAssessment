...
public class LoginStepDefs {
	...
	LoginPage loginPage = new LoginPage(SharedSteps.driver);
	//SearchPage searchPage = new SearchPage(SharedSteps.driver);
	

	@Given("I am on DemoWebShop Homepage launching {string}")
	public void i_am_on_demo_web_shop_homepage(String url) {
		SharedSteps.driver.manage().window().maximize();
		SharedSteps.driver.get(url);
